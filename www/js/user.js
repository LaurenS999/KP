function load_user(e, page)
{
    ...
    app.request({
        method: "POST",
        url: "http://192.168.0.15/myorder/user/profile.php",
        data: {  
...
function cekrole_profile()
{
    ...
    else if (localStorage.user_role == "Kasir")
    {
        ...
        // $$('#karyawan-name').html(localStorage.user_name);
        // $$('#karyawan-phone').html(localStorage.user_phone);
        // $$('#karyawan-email').html(localStorage.email);
    }
...
{   
    ...
    else 
    {
        app.request({
            method: "POST",
            url: "http://192.168.0.15/myorder/user/changenama.php",
            data: {  
                user_id : localStorage.user_id,
                nama : nama
            },
...
function GantiTelepon()
{
    ...
    else
    {
        app.request({
            method: "POST",
            url: "http://192.168.0.15/myorder/user/changetelepon.php",
            data: {  
                user_id : localStorage.user_id,
                user_phone : telepon
            },
...
{    
    ...
    else
    {
        app.request({
            method: "POST",
            url: "http://192.168.0.15/myorder/user/changeemail.php",
            data: {  
                user_id : localStorage.user_id,
                email : email
            },
...
{    
    ...
    else
    {
        app.request({
            method: "POST",
            url: "http://192.168.0.15/myorder/user/changepass.php",
            data: {  
                user_id : localStorage.user_id,
