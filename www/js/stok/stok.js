...
function default_kategori(halaman)
{    
    var id = 0;
    ...
    app.request({
        method: "POST",
        url: "http://192.168.0.15/myorder/stok/default_stok.php",
        data: {
            store_id: id
        },
        success: function(data) {
            ...
            if (obj['status'] == true)
            {
                ...
                {                    
                    KategoriDetil_Beranda_Kasir(obj['data'][0]['category_id']);
                }
            }
            else
            {
...
function StokList(id) //LIST MENU DENGAN STOK
{
    ...
    app.request({
        method: "POST",
        url: "http://192.168.0.15/myorder/stok/stok.php",
        data: {  
            kategori_id : id,
            store_id : store_id
        },
